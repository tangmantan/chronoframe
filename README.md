...
Create a `.env` file and configure environment variables. (tips: Version 1.0.0.rc.3 and later do not require manual creation of the `.env` file. You can configure environment variables directly in the browser.)
...
Version 1.0.0.rc.3 and later do not require manual creation of the `.env` file. You can configure environment variables directly in the browser.
